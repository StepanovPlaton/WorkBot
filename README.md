...
- **Картинки из описания**: первая прикрепляется к ответу, остальные — ссылками
...
- Картинка в описании: первая прикрепляется к сообщению, остальные становятся ссылкой «изображение»
